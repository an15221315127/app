 ...
 * @constructor
 */
export const withdrawRecord = (params: object) =>
  post('wallet/withdrawRecord', params);
 ...
 * @constructor
 */
export const changePayPassword = (params: object) =>
  post('user/changePayPassword', params);
 ...
 * @constructor
 */
export const ElectricityCharge = (num: number) =>
  post('electricity/buy', {num});
 ...
 * @constructor
 */
export const profitRecord = (params: object) =>
  post('user/profitRecord', params);
 ...
 * @constructor
 */
export const InstantExchange = (params: object) =>
  post('swap/InstantExchange', params);
 ...
 * @constructor
 */
export const transferConfig = (params: object) =>
  post('wallet/transferConfig', params);
 ...
 * @constructor
 */
export const transferRecord = (params: object) =>
  post('wallet/transferRecord', params);
